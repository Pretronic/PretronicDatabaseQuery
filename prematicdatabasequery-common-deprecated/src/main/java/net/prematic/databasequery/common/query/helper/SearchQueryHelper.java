...
public abstract class SearchQueryHelper<T extends SearchQuery<T>> extends EntryHelper<T> implements SearchQuery<T> {
    ...
    @Override
    public T orderBy(String field, SearchOrder orderOption) {
    ...
    @Override
    public T orderBy(AggregationBuilder aggregationBuilder, SearchOrder orderOption) {
